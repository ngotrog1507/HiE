...
namespace HiSchool.Areas.Admin.Controllers
{
    ...
    public class SysMenuController : Controller
    {
        ...
        private readonly SysMenuAction _sysAction = new SysMenuAction();
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.ListMenu = _sysAction.ListRecursive(0, 0, Ultity.Constant.Active);
            return View();
        }
        /// <summary>
        /// Index Page
        /// </summary>
        /// <param name="page">Current Index Page</param>
        /// <param name="key">Key word search</param>
        ...
        [HttpPost]
        public ActionResult Edit(SysMenu sysModel)
        {
            try
            {
                ...
                if (sysModel.Id > 0)
                {
                    ...
                    if (AuthorizeUser.IsAction(Ultity.Constant.Edit)|| AuthorizeUser.IsAction(Ultity.Constant.ViewEditAll))
                    {
                        ...
                        succcess = _sysAction.Update(sysModel.Id, sysModel.Link, sysModel.ParentId, sysModel.Name, sysModel.Icon, sysModel.Orders, CommonHelper.Convert.ConvertToInt32(sysModel.UsedState), CommonHelper.Convert.ConvertToInt32(sysModel.CreatedBy), CommonHelper.Convert.ConvertToDateTime(sysModel.CreatedDate), sysModel.ModifiedDate, sysModel.ModifiedBy);
                    }
                    else { succcess = 1; }
                }
                else
                {
                    if (AuthorizeUser.IsAction(Ultity.Constant.Add) || AuthorizeUser.IsAction(Ultity.Constant.ViewEditAll))
                    {
                        ...
                        succcess = _sysAction.Insert(sysModel.Link, sysModel.ParentId, sysModel.Name, sysModel.Icon, sysModel.Orders, CommonHelper.Convert.ConvertToInt32(sysModel.UsedState), CommonHelper.Convert.ConvertToInt32(sysModel.CreatedBy), CommonHelper.Convert.ConvertToDateTime(sysModel.CreatedDate), sysModel.ModifiedDate, sysModel.ModifiedBy);
                    }
                    else { succcess = 1; }
                }
